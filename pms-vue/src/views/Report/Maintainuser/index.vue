<template>
  <div class="app-container">
    <div slot="header" class="clearfix" style="text-align: center;padding-bottom: 20px">
      <span style="font-size: 20px">维修记录</span>
    </div>
    <div>
...
export default {
  ...
  computed: {
    ...mapState({
      tableData: state => state.maintainuser.table.data,
      total: state => state.maintainuser.table.total,
      pageSize: state => state.paymentuser.table.pageSize
    })
  },
  methods: {
    getuser () {
