  ...
  <div class="app-container">
    <el-dialog
      ...
      <el-form label-width="90px" ref="parkForm" :model="parkForm" :rules="rules">
        ...
        <el-col>
          <el-form-item label="车辆类型:"  prop="parkType">
            <el-select v-model="parkForm.parkType" placeholder="请选择车辆类型" style="width:100%">
                <el-option
        ...
        <el-col>
            <el-form-item label="车牌号码:"  prop="position">
                  <el-input  v-model="parkForm.position"  placeholder="请输入车辆车牌号码"/>
            </el-form-item>
        </el-col>
