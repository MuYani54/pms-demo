      ...
      children: [
        {
          path: 'manage',
          name: '管理员首页',
          component: resolve => require(['@/views/Home/Manage'], resolve),
          meta: { roles: ['admin', 'property'] } // 拥有 admin 或 property 角色的用户可以访问
        },
        {
          path: 'owner',
          name: '业主首页',
          component: resolve => require(['@/views/Home/Owner'], resolve),
          meta: { roles: ['owner'] } // 拥有 owner 角色的用户可以访问
        }
      ]
    },
    {
