 ...
 * @description:
 * @author: muyan
 * @date: 2023/04/22 12:06:21
 **/
@Repository
public interface RepairsRepository extends JpaRepository<Repairs,Long> {

    @Query("select new com.muyan.pms.entity.dto.RepairsDto(repairs.id,user.realName, repairs.repairsBillNo," +
    ...
    @Query("select new com.muyan.pms.entity.dto.RepairsReportDto(repairs.id,user.realName,repairs.repairsBillNo," +
