 ...
 * @description:
 * @author: muyan
 * @date: 2023/04/20 19:03:24
 **/
@Repository
public interface ParkRepository extends JpaRepository<Park,Long> {

    @Query("SELECT new com.muyan.pms.entity.dto.ParkDto(park.id ,user.username,park.useStatus,park.expireDate,park.parkType,park.position) FROM Park park " +
